...
private struct HealthAlert: Identifiable {
    ...
    let timestamp: String       // ex "Generated 2h ago"
}

struct HealthAlertsView: View {
    // Demo content — wired to fake-insights / backend logic
    @State private var alerts: [HealthAlert] = [
        .init(
            title: "Elevated stress pattern detected",
            detail: "Higher resting heart rate and shorter sleep compared to last week.",
            confidence: 92,
            timestamp: "Generated 2h ago"
        ),
        .init(
            title: "Mood fluctuation observed",
            detail: "More ‘sad’ check-ins than usual, possibly tied to reduced activity.",
            confidence: 88,
        ...
        ScrollView {
            VStack(spacing: 24) {
                ...
                VStack(spacing: 8) {
                    ...
                    Text("Generated from your latest weekly insights.")
                        .font(.system(size: 14))
